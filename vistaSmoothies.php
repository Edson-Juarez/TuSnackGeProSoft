...
<body>
    ...
    <section class="contenedor">
        ...
        <div class="contenedor-items">
            <?php
            include("conexion.php");
            $query = "SELECT * FROM producto WHERE Categoria = 'Smoothies' ORDER BY nombre_producto ASC;";
            ...
            while ($row = $resultado->fetch_assoc()) {
                ...
                <div class="item">
                    ...
                    <span class="titulo-item">
                        Categoria:
                        <br>
                        <?php echo ucfirst(strtolower($row['Categoria'])); ?>
                        <br>
                    </span>
                    <span class="titulo-item">
                        Código de producto:
                        <?php echo ucwords(strtolower($row['codigo'])); ?>
                    </span>
                    <span class="precio-item">
                        <?php echo ucwords(strtolower($row['precio_unitario'])); ?>
                    </span>
                    <span class="precio-item">
                        Stock disponible:
                        <?php echo ucwords(strtolower($row['stock'])); ?>
                    </span>
                    <?php if ($row['stock'] == 0): ?>
                        <br>
